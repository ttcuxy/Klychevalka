  ...
  return (
    <div className="bg-background text-foreground">
      <div className="min-h-screen flex flex-col">
        <header className="border-b p-4 sticky top-0 bg-background/95 backdrop-blur-sm z-10">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-input border border-border rounded-md px-3 py-2 text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background transition"
                      value={apiKey}
                  ...
                  <button
                    id="verify-key-btn"
                    className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-2 px-4 rounded-md transition-colors"
                  >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full bg-input border border-border rounded-md px-3 py-2 text-foreground disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                    >
                  ...
                  <div>
                    ...
                    <textarea
                      id="prompt-input"
                      disabled
                      className="w-full bg-input border border-border rounded-md px-3 py-2 text-foreground h-48 resize-none disabled:opacity-50 disabled:cursor-not-allowed focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                      defaultValue={prompt}
                    />
                  </div>
                </div>
              ...
              <div className="bg-card border rounded-lg p-6 shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div
                    ...
                    className="space-y-2 max-h-96 min-h-[6rem] overflow-y-auto p-2 border border-border rounded-md bg-background/50 flex items-center justify-center"
                  >
                  ...
                  <div className="flex gap-4">
                    ...
                    <button
                      id="download-btn"
                      disabled
                      className="flex-1 bg-secondary hover:bg-secondary/80 text-secondary-foreground font-semibold py-2 px-4 rounded-md transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Download All as ZIP
                    </button>
                  </div>
